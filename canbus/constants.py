...
COMMAND_NAMES = {
    ...
    BUZZ_PLAY: "BUZZ_PLAY",
    BUZZ_STOP: "BUZZ_STOP",
    REQUEST_FULL_UID: "REQUEST_FULL_UID",
    DEVICE_RESET: "DEVICE_RESET",
    FACTORY_RESET: "FACTORY_RESET",
    REQUEST_HEALTH: "REQUEST_HEALTH",
    REQUEST_VERSION: "REQUEST_VERSION",
    REQUEST_DEVICE_INFO: "REQUEST_DEVICE_INFO",
    WL_WRITE_UID: "WL_WRITE_UID",
    WL_DEL: "WL_DEL",
    WL_CLEAR: "WL_CLEAR",
    WL_WRITE_UID_PART2: "WL_WRITE_UID_PART2",
    WL_DEL_PART2: "WL_DEL_PART2",
    COMMAND_WL_ADD_EPHEMERAL: "COMMAND_WL_ADD_EPHEMERAL",
    REQUEST_WL_LIST: "REQUEST_WL_LIST",
    REQUEST_WL_INFO: "REQUEST_WL_INFO",
    WL_ADD_EPHEMERAL_PART2: "WL_ADD_EPHEMERAL_PART2",
    SET_LOCK_MODE: "SET_LOCK_MODE",
    REQUEST_LOCK_MODE: "REQUEST_LOCK_MODE",
    DELETE_WL_SLOT: "DELETE_WL_SLOT",
    REQUEST_WL_LIST_V2: "REQUEST_WL_LIST_V2",
    REQUEST_OCCUPANCY_STATE: "REQUEST_OCCUPANCY_STATE",
    AUTH_RESP: "AUTH_RESP",
    SET_WL_SLOT_POLICY: "SET_WL_SLOT_POLICY",
}
